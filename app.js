(() => {
  ...
  const STORAGE_KEY = "biz-dashboard-data-v5";
  ...
  function seedData() {
    ...
    const weakTechProject = P({
      ...
      endDate: "2026-07-31",
      memo: "과제번호 WW250072, 과제명: AI 기반 실시간 노인 돌봄 위험 예측 모니터링 연구 개발(협약차수 1). 정부지원금 규모는 예산 계획 자료에 없어 0으로 표기(확인 후 입력 필요) — 사업비는 자부담금(현금+현물) 기준. 실행 집행 내역은 2026-01-16~2026-05-07 집행분(연구활동비 7건, 내부인건비 8건, 합계 109,519,485원)을 반영함. 단, 원본 집행내역 파일 자체의 '합계' 행은 183,981,095원으로 더 높게 표기되어 있어, 이 파일에 포함되지 않은 집행 건이 남아있을 수 있음 — 전체 내역인지 원본 시스템에서 재확인 필요.",
      progress: 92,
      budget: { governmentFund: 0, selfFund: 160000000 },
      budgetPlan: { 인건비: 113500000, 재료비: 0, 외주비: 0, 장비비: 0, 여비: 0, 기타: 46500000 },
      expenses: [
        E("2026-01-16", "기타", 6628529, "메가존클라우드 AWS 클라우드 요금(연구활동비, 17:44:33 집행)"),
        E("2026-01-16", "기타", 6859667, "메가존클라우드 AWS 클라우드 요금(연구활동비, 17:44:31 집행)"),
        E("2026-01-16", "기타", 6263084, "메가존클라우드 AWS 클라우드 요금(연구활동비, 17:44:29 집행)"),
        E("2026-04-09", "기타", 4591281, "메가존클라우드 AWS 클라우드 요금(연구활동비, 11:44:55 집행)"),
        E("2026-04-09", "기타", 6573913, "메가존클라우드 AWS 클라우드 요금(연구활동비, 11:44:53 집행)"),
        E("2026-04-09", "기타", 7251131, "메가존클라우드 AWS 클라우드 요금(연구활동비, 11:44:52 집행)"),
        E("2026-05-07", "기타", 3875140, "메가존클라우드 AWS 클라우드 요금(연구활동비, 15:39:25 집행)"),
      ],
      milestones: [
